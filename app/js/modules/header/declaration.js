(function() {
  define(["boxModel", "dropDownListModel", "comboboxListCollection"], function(BoxModel, DropDownListModel, ComboboxListCollection) {
    var declaration;
    return declaration = {
      componentItems: [
        {
                ...
                innerComponent: {
                  ...
                  model: new DropDownListModel({
                    ...
                    collection: new ComboboxListCollection([
                      {
                        text: "loc_FlightStatus",
                        url: "!/flight-stats"
                      }, {
                        text: "loc_ScheduleFlights",
                        url: "!/flight-stats/resultSort"
                      }, {
                        text: "loc_AdditionalServices",
