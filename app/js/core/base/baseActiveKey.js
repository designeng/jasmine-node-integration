(function() {
  define(["underscore", "backbone", "jquery", "core/utils/view/applyModelPropertiesToViewProperties", "core/utils/locale/prepareLocalized", "i18n!nls/general"], function(_, Backbone, $, applyModelProperties, prepareLocalized, localized) {
    var BaseActiveKey;
    BaseActiveKey = function(baseOptions) {
      var BackboneKeysMap, KeyActiveBaseView, getKeyCode, oldDelegateEvents, oldUndelegateEvents;
      ...
      return KeyActiveBaseView = baseOptions.BaseObject.extend({
